...
public interface CalcModel {
	 ...
	 */
	double getCurrOperand() throws IllegalStateException;
	 ...
	 * 
	 * @param currOperand vrijednost koju treba pohraniti kao aktivni operand
	 */
	void setCurrOperand(double currOperand);
